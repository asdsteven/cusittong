...
func (s *parser) parseSubjectsAll(icsid string) ([][2]string, error) {
...
setFocus_win0('CU_SUBJECT_DVW_SUBJECT',-1);
...
<br /><input type=button id='#ICSearch' name='#ICSearch'  class='PSPUSHBUTTONTBLOOKUP'  value='Look Up' onclick="javascript:submitAction_win0(document.win0, '#ICSearch');" tabindex='25' PSaccesskey='\' alt='Look up (Alt+1)' title='Look up (Alt+1)'>
<input type=button id='#ICCancel' name='#ICCancel'  class='PSPUSHBUTTONTBCANCEL'  value='Cancel' onclick="javascript:submitAction_win0(document.win0, '#ICCancel');" tabindex='26' alt='Cancel (Esc)' title='Cancel (Esc)'>
<a name='#ICAdvSearch' class='PSHYPERLINK' href="javascript: submitAction_win0(document.win0,'#ICAdvSearch');" tabindex='27'>Advanced Lookup</a>
<br /><br />
<span class='PSSRCHSUBTITLE' >Search Results</span>
<br />
<table class='PSSRCHRESULTSTITLE' dir='>ltr' cellpadding='1' cellspacing='0'>
<tr valign='baseline'>
<td align='left' nowrap='nowrap'><span class='PSSRCHRESULTSHYPERLINK' ><a name='#ICViewPage' class='PSSRCHRESULTSHYPERLINK' href="javascript: submitAction_win0(document.win0,'#ICViewPage');" tabindex='28'>View 100</a></span>
&nbsp;&nbsp;&nbsp;</td>
...
<tr align='left'><th scope='col' class='PSSRCHRESULTSHDR' ><a tabindex='29' class='PSSRCHRESULTSHDR' name='#ICSortCol0' href="javascript:submitAction_win0(document.win0,'#ICSortCol0');" title='Click column heading to sort ascending'>Subject Area</a></th><th scope='col' class='PSSRCHRESULTSHDR' ><a tabindex='30' class='PSSRCHRESULTSHDR' name='#ICSortCol1' href="javascript:submitAction_win0(document.win0,'#ICSortCol1');" title='Click column heading to sort ascending'>Description</a></th></tr>
`
	const last = `</table>
...
`
	...
	if err := s.spanErr(afterViewAll2); err != nil {
		return nil, fmt.Errorf("afterViewAll2\n%v", err)
	}
	return s.parseSubjectRows(rows, 31)
}
