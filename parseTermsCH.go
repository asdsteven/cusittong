...
func (s *parser) parseTermsCH(icsid string) ([][2]string, error) {
...
<option value="ZHT" selected='selected'>Traditional Chinese</option>
</select></label></td>
...
<option value=""></option>
<option value="TPG">修讀式課程研究生</option>
<option value="PGDE">學位教師教育文憑生</option>
<option value="UG" selected='selected'>本科生</option>
<option value="RPG">研究式課程研究生</option>
</select>
</td>
</tr>
</table>
